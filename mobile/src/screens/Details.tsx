...
export function Details() {
  ...
  function handleOrderClose(){
    if(!solution){
      return Alert.alert('Atenção', 'Por favor, insira uma solução');
    }
  ...
  return (
    <VStack flex={1} bg="gray.700">
      ...
      <Text fontSize="sm" color={order.status == 'closed' ? colors.green[300] : colors.secondary[700]} ml={2} textTransform="uppercase">
